        ...
        bg-cover">
            <Container>
                <div className=" flex-1 max-w-[500px]">
                    <h1 className="text-white text-7xl font-bold mb-4">Tenha seu banco na palma da mao</h1>
                    <p className="text-white text-xl max-w-[408px] mb-8">Todas as operacoes que voce precisa em um so lugar. simples,
                        completo e feito pra voce.
                    </p>
